...
To create a desired chart or table in a Dashboard or report, you may sometimes need to “pivot” or “unpivot” the data in one of the following ways:

...
. Right-click the data block, and select ‘Show Plan’ from the context menu. {rightClickOptions} #anothernote#
+
...
+
image:dataworksheet:queryPlanJoin.gif[]
+
...
+
image:dataworksheet:queryPlanSingleSQL.gif[]
...
. Deselect ‘Merge SQL’ and press ‘OK’ to exit the panel.
+
image:dataworksheet:showPlanOption.gif[]
+
Right-click the data block, and select ‘Show Plan’ again.
+
image:dataworksheet:queryPlanPostProcess.gif[]
+

...
+
This opens the Data Worksheet for editing in Visual Composer. You can now do mashup operations on this Data Worksheet, as described in the following sections (xref:dataworksheet:FilterData.adoc[], xref:dataworksheet:JoinData.adoc[], etc.).

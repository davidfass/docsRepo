...
. Enter the next three thresholds, pressing ‘Add’ after each one: 10000, 50000, 100000.
+
image:numericRangeDialogFilled.gif[]
+
...
+
image:numericRangeDialogRelable.gif[]
...
+
image:numericRangeDialogResult.gif[]
. #Optional:#  Instead of defining a fixed minimum and maximum value (750,000-10,000,000), you can keep the numeric range open-ended. Follow the steps below:
...
+
image:numericRangeDialogReopen.gif[]
.. Select the ‘Greater than Max’ option, enter a label, and press btn:[OK].
+
image:numericRangeDialogLessThanMin.gif[]
...
+
image:dateRangeDialog1.gif[]
This opens the ‘Date Range Option’ panel. Here you can specify the date grouping.
+
image:dateRangeDialog2.gif[]
. Enter a name for the new range column.
+
include::ROOT:partial$duplicateNames.adoc[]
. Select the desired partitioning (year, month, quarter, etc.), and press btn:[OK].

There are five date ranges available for the date range column:

...
. Select the desired Excel file and press btn:[Open]. (Here we use the sample xref:data:attachment$OrderDataText.xls[OrderDataText] Excel file.)
+
image:uploadFile1.gif[]

...
image:commonscript:areaChartExp5.png[]
...
.Explore More...
****
The sample xref:ROOT:attachment$Financial_Client_Demographics.zip.zip[Financial Client Demographics] Dashboard provides an example of an area chart.

image:viewsheet:galleryWaterfall2.png[]

To explore this sample Dashboard, download and import the  xref:ROOT:attachment$Financial_Client_Demographics.zip.zip[Financial Client Demographics] Dashboard into your environment. (This requires access to Enterprise Manager.) See xref:administration:ImportExportAssets.adoc[] for instructions on how to import.
****

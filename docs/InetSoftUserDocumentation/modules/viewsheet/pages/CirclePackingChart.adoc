...
****
This example illustrates how to create a circle packing that displays total broken down by state, city, and product name.
...
. *_Optional:_* Press the ‘Edit Color’ button next to the ‘State’ dimension, and choose the desired colors to represent the state values. Press the {buttonClose}.

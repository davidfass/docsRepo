...
To *immediately* email a Dashboard  to other users, follow the steps below.  To schedule a Dashboard to be periodically emailed, see xref:ScheduleDashboard.adoc[].

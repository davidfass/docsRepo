...
+
image:wizard9.png[]
.. *_Optional:_* To make more detailed adjustments to the component, press the {buttonFullEditor} in the top toolbar.  See xref:AddTableOrCrosstab.adoc[] for more information about how to use the Crosstab Editor.
+
...
.. *_Optional:_* To make more detailed adjustments to the component, press the {buttonFullEditor} in the top toolbar.  See xref:AddTableOrCrosstab.adoc[] for more information about how to use the Table Editor.
+
...
.. To change the formatting for a numerical-type field or a date-type, press the  and select the desired format. (See xref:DataFormat.adoc[] for more information about the available format options.)
+
image:wizard14.png[]

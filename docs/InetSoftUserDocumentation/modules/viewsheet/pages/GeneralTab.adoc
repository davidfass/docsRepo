...
Visible in External Dashboards::	If checked, the component will be visible when this Dashboard is embedded in another Dashboard (see xref:user:ModularizeDashboard.adoc[]).
Visible::

...
. Press the {buttonSelectChartStyle}. Choose the ‘Bar’ or ‘3D Bar’ style.  (To create a stacked area chart, enable the ‘Stack’ option at the bottom of the panel.) Press the {buttonApply}.
+

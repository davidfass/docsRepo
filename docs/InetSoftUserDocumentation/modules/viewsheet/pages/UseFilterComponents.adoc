...
The following sections explain how to *use* filter components to dynamically explore your data.  See xref:AddFilterComponents.adoc[] for information on how to add these components into a Dashboard.

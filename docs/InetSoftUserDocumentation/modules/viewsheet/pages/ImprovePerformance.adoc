...
+
If you select the ‘Run in Background’ option, the materialized view will be scheduled to begin generation. You can check the status of the task under the *Schedule* page. (See xref:ScheduleDashboard.adoc[]. for more information about managing scheduled tasks).

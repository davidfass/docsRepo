...
NOTE: This feature is also available to end-users who view the host Dashboard in the Portal if there is at least one hidden element in the embedded Dashboard. (See xref:viewsheet:GeneralTab.adoc[] for more information about hiding components.)

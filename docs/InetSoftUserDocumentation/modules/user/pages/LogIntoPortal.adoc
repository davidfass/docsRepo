...
If the server is running, simply enter the server URL in any browser. Your administrator can provide this URL. (The default URL for the User Portal on a local server is `http://localhost:8080/app/portal/`.)

...
== Move an Asset
To move reports, Dashboards, or folders from one Repository folder to another, follow the steps below:
...
== Delete an Asset
To delete a report, Dashboard, or folder from the Repository, follow the steps below:
...
== Rename an Asset
To rename a report, Dashboard, or folder, follow the steps below:

...
Create New Data Source:: Permission to select {buttonDataSource} from the {buttonCreate} in the Portal. Requires also permission for the Portal Data tab (see ‘Portal Tabs’ above). (See xref:ROOT:ConnectToData.adoc[] for more information.)

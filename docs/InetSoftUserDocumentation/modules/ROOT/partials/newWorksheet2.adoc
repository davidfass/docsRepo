...
+
image::newWorksheet3.png[width=440]
+
...
+
image::embeddedTable4.png[width=440]
+
...
+
. To *add a description for a column*, press the {buttonActions}  in the column header and select ‘Column Description’. See xref:dataworksheet:ModifyColumn.adoc[] for more information.
+

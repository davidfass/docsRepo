...
+
. To *add a description for a column*, press the {buttonActions}  in the column header and select ‘Column Description’. See Add a Column Description for more information.
